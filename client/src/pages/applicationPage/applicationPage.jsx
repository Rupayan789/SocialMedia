...
import ApplicationRightSidebar from './components/applicationRightSidebar'
    ...
    return (
        <div>
            ...
            <div className="application-body">
                ...
                <div className="application-body-right">
                    <ApplicationRightSidebar/>
                    <div className="application-body-right-caption">Suggested Friends</div>
                    <ApplicationCarousel/>
                </div>
            </div>
        </div>
